...
import SOCIAL from "../assets/socials"
function Footer() {
  return (
    <footer className='flexCenter pb-16 pt-20'>
      <div className='max_padd_container flex w-full flex-col gap-14'>
        ...
        <div className='border bg-gray-20' ></div>
          <p className='text-center regular-14 text-gray-30 '>2024 Ahmad Shaar | All rights reserved.</p>
      </div>
    </footer>
  )
}
